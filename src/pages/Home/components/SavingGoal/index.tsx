...
const SavingGoal = () => {
  ...
  return (
    <div className="saving-goal">
      ...
      <h2 className="saving-goal__title">Buy a house</h2>
      <p className="saving-goal__subtitle">Saving goal</p>
      ...
      <button className="saving-goal__button">Confirm</button>
    </div>
  );
};
